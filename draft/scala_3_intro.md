...
Neuerungen im Detail vorgestellt.  In diesem ersten Teil der Reihe wird der neue
...
Zwar werden Neuerungen und Änderungen in der Sprache von grundauf erläutert und
Vergleiche zu Scala 2 ausführlich erklärt, dennoch unterstützt die Kenntniss von
Scala 2 das Verständniss dieses Blogposts.
...
lieben diesen Ansatz, da er visuell gleichmäßigeren und rauschfreieren Code zur
...
miteinander vermischt werden. Das hier die Befürchtung aufkommt, dass eine
fragmentierte Syntaxlandschaft entsteht, ist durchaus nachvollziehbar.


## Geschweifte Klammern sind optional

Betrachten wir die folgende kleine Scala-Klasse und deren Companion-Objekt.
...
Rumpf, wie im Beispiel in der Case-Class- und Object-Definition zu sehen ist. Die folgende
...
Leerzeichen sind equivalent zu sechs Leerzeichen. Die
...
Im obigen Beispiel sieht man im Scala 3 Code ein neues Schlüsselwort: `then`.
...
* die Bedingung einer While-Schleifen wird von einem `do` angeschlossen
* der Rumpf einer Vorschleife kann sowohl von `yield` als auch `do`
...
eingeleitet werden und durch Einrückungen vom Rest abgegrenzt werden. Wird
...
Der _Scala 3_-Compiler kommt mit einer handvoll features, um mit der neuen Syntax
...
unterbinden möchte und die klammerfreie Syntax abschalten möchte, kann dem
...
strikten Formatter viele Ausprägungen von _Scala 3_-Code hervorrufen, bis sich ein
